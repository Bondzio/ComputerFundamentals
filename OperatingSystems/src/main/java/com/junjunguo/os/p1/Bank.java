...
public class Bank {
    ...
    /**
     * Deposit a given amount of money. The money is put in the night safe. If there is too much money in the night
     * safe, all the money is transferred to the vault.
     */
...
//            nightSafeAmount = 0;
    ...
    public void courierDone() {
        ...
        if (nofActiveCouriers == 0) {
            ...
            int moneyInBank    =   nightSafeAmount;
...
//            int moneyInBank    = nightSafeAmount + vaultAmount;
    ...
    @Override public String toString() {
        return " vault amount: "+vaultAmount;
    }

    /**
     * Reads the number of couriers and the number of visits to the bank for each courier from the command line
     * parameters, and starts the simulation.
     */
    public static void main(String[] args) {
        int nofCouriers, nofVisits;
        if (args.length < 2) {
            ...
            nofVisits = new Integer(args[1]).intValue();
            nofCouriers = new Integer(args[0]).intValue();
        }
