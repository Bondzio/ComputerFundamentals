...
/**
 * Graphical component used to display a resource in a queuing network. The resource may represent a CPU, memory, etc,
 * and is displayed as a circle with a name. The resource may also contain an active process.
 */
