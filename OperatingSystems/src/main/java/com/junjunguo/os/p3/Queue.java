...
/**
 * A queue in a queuing network. This class both offers ordinary queue functionality, as well as serving as a graphical
 * component. This means that updates to the queue will be automatically displayed in the GUI.
 */
public class Queue extends JPanel implements Constants {
    ...
    /**
     * Paints the queue as a horizontal row of slots containing processes. This method assumes that the elements of the
     * queue are Process objects.
     *
